...
import 'package:evently/ui/home/taps/Home_tab/Profile/widgets/bottom_sheet_container.dart';
...
class DialogUtils {
  ...
  static void massageDialog({
    ...
    showDialog(
      barrierDismissible: false,
      // to do not allow user to close dialog from screen if click on it
      context: context,
  ...
  static void showBottomLanguageSheet({required BuildContext context}) {
